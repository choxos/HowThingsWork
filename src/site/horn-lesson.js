export const hornLesson={
 ...
 steps:[
  ...
  {title:'Let the diaphragm spring back',body:'The bent diaphragm pushes the bar back as the magnetic pull weakens. The contact closes again and a new cycle begins. Time since press shows physical milliseconds; the displayed motion runs one hundred times slower so you can follow it.'},
 ...
 tryIt:[
  {title:'Sound a short horn pulse',instruction:'Step through the start of the cycle, then press Play. Enable Sound on if you want the audible demonstration.',observe:'The supported diaphragm center vibrates with the iron bar. At 12 V, the 40 ms press gives nine complete diaphragm cycles at about 256 Hz. Contact breaks counts the ten openings, including startup; it differs from full-cycle count.',reset:true,part:'system',view:'front',isolate:false,values:{voltage:12,holdTime:.04,contact:0,sound:0}},
  ...
  {title:'Keep the pulse on longer',instruction:'Press Play for 120 ms at the same 12 V supply. Compare cycle count and frequency with the short pulse.',observe:'Thirty complete cycles occur instead of nine. The established frequency stays near 256 Hz; a longer press extends vibration instead of making each cycle three times faster.',reset:true,part:'system',view:'front',isolate:false,values:{voltage:12,holdTime:.12,contact:0,sound:0}},
  {title:'Compare a stronger supply',instruction:'Press Play at 15 V for the original 40 ms. Compare frequency, contact breaks and pole clearance with the 12 V result.',observe:'Ten complete cycles occur at about 265 Hz. The stronger pull changes feedback timing slightly. The bar still remains clear of the pole; loudness is not calculated.',reset:true,part:'system',view:'front',isolate:false,values:{voltage:15,holdTime:.04,contact:0,sound:0}},
 ],
 deeper:[
  {title:'An illustrative pitch, not a product rating',body:'Real horn designs use different masses, diaphragms and acoustic chambers. For example, HELLA lists low-tone models at 300–335 Hz and high-tone models at 380–450 Hz. This model’s roughly 256 Hz is an illustrative outcome, not a prediction for those products or a universal horn frequency.'},
  {title:'The diaphragm is also a spring',body:'The diaphragm does two jobs: it moves air and provides a restoring force. With illustrative stiffness k = 18,000 N/m and effective moving mass m = 0.008 kg, the undamped estimate f₀ = √(k/m)/(2π) is about 239 Hz. The powered feedback cycle runs near 256 Hz at 12 V because magnetic pull, switching and damping also affect its timing.'},
 ...
 sources:[
  {title:'OpenStax: mass-spring motion, period and natural frequency',url:'https://openstax.org/books/university-physics-volume-1/pages/15-1-simple-harmonic-motion'},
  {title:'HELLA: example electromechanical horn frequency ranges',url:'https://www.hella.com/soe/en/Products/Product-detail-4957/?pid=6347'},
