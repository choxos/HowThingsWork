export const electromagnetLesson={
 ...
 deeper:[
  ...
  {title:'Pickup and holding are different conditions',body:'For this model at 2 A, attraction is about 10 N across the initial 2 mm air gap plus the 0.2 mm protective layer. Once the iron reaches the protective layer, only its 0.2 mm magnetic gap remains and attraction rises to about 550 N. These are teaching estimates, not lifting ratings. A 1.5 kg load weighs about 15 N, so it cannot cross the initial gap even though the same magnet could hold it in contact. The smaller central pole carries the same flux as the outer ring through less area, so its flux density is greater. This model caps the central value at 1.4 T to approximate saturation.'},
 ],
