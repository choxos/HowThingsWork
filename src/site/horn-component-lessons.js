...
export const hornComponentLessons={
 'Electric-horn moving iron bar':{
  ...
  steps:[
   ...
   {title:'Return and repeat',body:'Press Play. The diaphragm’s spring action returns the bar as current fades. Your bar inspection stays in place at completion and replay. Compare repeated vibration with a bypassed held position or a weak pull; Inspect the horn result opens the whole mechanism.'},
  ],
  parts:[
   ...
   {name:'Fixed coil and insulating bobbin',role:'Keep the winding supported around the moving bar, with clearance so the bar can travel without rubbing.'},
  ...
  tryIt:[
   ...
   {title:'Increase the pull without hitting the pole',instruction:'Press Play at 15 V for the same 40 ms hold. Compare the center movement, Pole air gap and final cycle count with the 12 V trial.',observe:'This model reaches about 0.685 mm peak travel, compared with 0.613 mm at 12 V. The gap remains above 0.814 mm, and ten complete cycles occur instead of nine. The stronger supply still makes a vibrating diaphragm, not a hammer striking the pole.',reset:true,part:'moving-bar',view:'front',isolate:false,values:{voltage:15,holdTime:.04,contact:0,sound:0}},
  ],
  deeper:[
   ...
   {title:'A shrinking gap changes the pull',body:'For a given current, this model increases magnetic pull as the bar approaches the pole: force is proportional to current squared divided by gap squared, with an 8 N cap. The diaphragm’s opposing spring force also grows with displacement. Contact interruption reduces current before the bar reaches the pole. This simplified force law and the displayed travel are teaching-model choices, not specifications for a real horn.'},
 ...
 'Horn make-and-break contacts':{
  ...
  steps:[
   ...
   {title:'Lift the leaf',body:'Keep stepping. The actuator reaches the underside of the leaf extension and bends it upward. The contact faces separate, Contact breaks increases and coil current begins to fade.'},
   ...
   {title:'Compare openings with vibration',body:'Press Play to finish while keeping your contact inspection. Compare Contact breaks with Diaphragm cycles, then try the open contact or bypass. Inspect the horn result opens the whole mechanism.'},
  ],
  parts:[
   {name:'Fixed insulated support',role:'Anchors the leaf root and holds separate terminals without conducting through the metal housing.'},
  ...
  tryIt:[
   {title:'Interrupt and restore the current',instruction:'Advance several steps while comparing the contact gap with the current reading. Then press Play.',observe:'The leaf opens and recloses as the bar and diaphragm move. Ten contact openings accompany nine complete diaphragm cycles. Startup and the way complete periods are counted make these two counters different.',reset:true,part:'contacts',view:'front',isolate:false,values:{voltage:12,holdTime:.04,contact:0,sound:0}},
   ...
   {title:'Keep feedback with a lower supply',instruction:'Press Play at 9 V for the same 40 ms hold. Compare contact breaks, cycle count and measured frequency with the 12 V trial.',observe:'The actuator still reaches the leaf: ten breaks and nine complete cycles occur. Frequency is about 248 Hz instead of 256 Hz. A slightly slower cycle need not change the whole-cycle count in this short pulse.',reset:true,part:'contacts',view:'front',isolate:false,values:{voltage:9,holdTime:.04,contact:0,sound:0}},
  ],
  deeper:[
   {title:'Clearance sets the switching point',body:'The bar moves through 0.35 mm before its insulated tab reaches the leaf extension. Further travel lifts the moving pad off the fixed pad. This chosen clearance stays fixed in the model. Held open retracts the fixed pad by 1.2 mm to create a fault; it is not a continuous tuning control or a new normal break setting.'},
 ...
 'Vibrating horn diaphragm':{
  ...
  steps:[
   ...
   {title:'Turn repeated bending into sound',body:'Press Play to finish the pulse while keeping your diaphragm inspection. The center repeatedly moves on both sides of rest. Peak center movement retains the largest travel toward the pole. Optional Sound on gives a teaching tone at the calculated frequency; Inspect the horn result opens the whole mechanism.'},
  ...
  parts:[
   ...
   {name:'Fixed electromagnetic coil',role:'Builds the magnetic pull that drives the attached iron bar; it stays fixed as the diaphragm bends.'},
   {name:'Fixed iron pole and air gap',role:'Provide the stationary face approached by the moving bar, with clearance throughout the diaphragm’s stroke.'},
   {name:'Hollow chamber and projector',role:'Connect the diaphragm’s air motion to the open horn outlet.'},
  ],
  tryIt:[
   {title:'Keep the rim fixed while the center vibrates',instruction:'Step through the first stroke and compare the center fixing with the dark clamping rings. Then press Play.',observe:'The center and bar move together; the rim stays fixed. Completion retains your diaphragm view and records nine cycles, an established tone and 0.613 mm peak movement.',reset:true,part:'diaphragm',view:'front',isolate:false,values:{voltage:12,holdTime:.04,contact:0,sound:0}},
   ...
   {title:'Compare a stronger pulse',instruction:'Press Play at 15 V with the same 40 ms hold. Compare Peak center movement, Vibration frequency and Diaphragm cycles with the normal 12 V trial.',observe:'Peak movement grows from 0.613 to 0.685 mm, frequency changes from about 256 to 265 Hz, and ten complete cycles occur instead of nine. The rim stays clamped. This model does not predict how loud either pulse would be.',reset:true,part:'diaphragm',view:'front',isolate:false,values:{voltage:15,holdTime:.04,contact:0,sound:0}},
  ],
  deeper:[
