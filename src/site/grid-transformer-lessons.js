...
export const transmissionTransformerLesson = {
  ...
  deeper: [
    ...
    {title: 'How good a machine this size has to be', body: 'The regulation sets a minimum Peak Efficiency Index of 99.770 percent for a liquid immersed large power transformer of 100 MVA or more, from the second of its two tiers. It is a stiff figure: at 400 MVA it allows 158.73 kW of no load loss and 1,333.04 kW of load loss, which sounds enormous until you set it against 400.000 MW passing through.'},
