...
export const airConditionerLesson = {
  ...
  tryIt: [
    room('Cool the room down', 'Press Play and watch the room.', 'The unit takes 4,161 W out of the room, 2,317 W of it cooling the air and 1,844 W drying it, and the room reaches the setting after 12.0 min.'),
    air('Dry air', 'Set the relative humidity to 20%.', 'Nothing condenses: the coil sits at 6.7 °C, above the air’s dew point of 3.0 °C, so all 3,310 W goes into cooling and the room arrives in 7.5 min.', {humidity: 20}),
    air('Damp air', 'Set the relative humidity to 90%.', 'Now the coil takes 4.86 kg of water an hour out of the air; 3,318 W of the 4,891 W goes into drying rather than cooling, and the room takes 19.0 min to arrive.', {humidity: 90}),
    fan('Starve it of air', 'Set the indoor airflow to 0.05 m³/s.', 'The coil falls to 1.2 °C and the air leaves at 5.2 °C, but the unit moves only 2,684 W in all, so the room takes 24.3 min.', {flow: 0.05}),
    fan('Open it up', 'Set the indoor airflow to 0.3 m³/s.', 'The coil rises to 17.3 °C, cooling takes 70% of the work instead of 56%, the water taken out falls to 2.12 kg/h, and the room arrives in 8.0 min.', {flow: 0.3}),
    pump('A hot day', 'Set the outdoor air temperature to 45 °C.', 'The hot coil now has to run at 56.6 °C to shed its heat, so the compressor takes 1,339 W instead of 1,066 W and the coefficient of performance falls from 3.90 to 2.89.', {outdoor: 45}),
    room('A bigger room', 'Set the room volume to 80 m³.', 'The unit works exactly as hard, 4,161 W, but twice the room holds twice the heat, so it takes 23.8 min to arrive instead of 12.0 min.', {volume: 80}),
  ],
  deeper: [
    {title: 'Two jobs, one coil', body: 'A cooling coil does two separate things at once. Sensible cooling lowers the air’s temperature: the air’s mass each second times its heat capacity times the drop. Latent cooling condenses its water: the water removed each second times the heat that water gives up turning back into liquid, which the Latent heat page’s fit puts at 2,470 J/g at this coil. At the settings this page opens on, 2,317 W of the 4,161 W is sensible and 1,844 W is latent, so 56% of the work is cooling and 44% is drying. The Air conditioning page notes that running less air over the coil raises the share that goes into drying, and warns that too little airflow can ice the coil up.'},
    {title: 'Why cold air drips', body: 'The Humidity page calls the water in air its humidity ratio, the grams of water riding with each kilogram of dry air, and the Arden Buck equation gives the most air can hold at a temperature. At 28 °C and 60% the room’s air carries 14.25 g/kg and would be full at 19.5 °C, its dew point. Anything colder than that cannot keep it, so a coil at 13.1 °C takes water out until the air leaving carries 10.11 g/kg. Cooling air without drying it raises its relative humidity, which is why air leaves this coil at 93% while the room it came from was at 60%, and why the room ends the run at 67% even though it is cooler.'},
    {title: 'Boiling on purpose', body: 'The trick of the whole machine is that a boiling liquid holds its temperature. R-410A boils at 48.5 °C below zero under one atmosphere and needs 1.383 MPa above the atmosphere, 1.484 MPa in all, to stay liquid at 21.1 °C. Clausius and Clapeyron drawn through those two points give 2,550 K and a latent heat of 292 kJ/kg. The line takes that latent heat as fixed, which is why it overshoots at the top: extrapolated to the critical point the line reaches 5.42 MPa, above the 4.90 MPa the table gives, because a real latent heat shrinks to nothing there. Over the loop’s own range it serves. Let it boil at 11.65 bar and the coil sits at 13.1 °C whatever the room throws at it.'},
    {title: 'What the compressor is really for', body: 'Heat only runs downhill, so to give the room’s heat to air that is hotter than the room, the refrigerant has to be lifted above the outdoor air first. The compressor swallows vapor at 11.65 bar and pushes it out at 29.63 bar, a pressure ratio of 2.54. It never fills completely: the vapor left behind in its clearance has to expand again before any new vapor can come in, so an 11 cm³ swept volume turning 2,900 times a minute fills 95.0% of the way and moves 17.64 g of refrigerant a second.'},
    {title: 'Where the heat goes', body: 'Nothing is destroyed on the way. Everything taken out of the room plus everything the compressor put in has to leave through the outdoor coil: 4,161 W and 1,066 W make 5,226 W blowing out of the outdoor unit. That coil sheds its heat only by standing above the outdoor air, so a hotter day pushes the condensing temperature up, the pressure ratio up and the work up with it: from 35 °C outdoors to 45 °C the compressor goes from 1,066 W to 1,339 W while the cooling it delivers falls from 4,161 W to 3,869 W.'},
    {title: 'How good can it get', body: 'The measure is the coefficient of performance, cooling over the work it takes, and this unit gives 3.90: it moves four units of heat for each unit of electricity, which no heater can do. The Coefficient of performance page gives most air conditioners 3.5 to 5, and a perfect machine working across the same 33.5 °C would reach 8.5, so this one is 46% of the best there is. Its capacity, 4,161 W, is 1.18 tons of refrigeration, a ton being exactly 12,000 BTU an hour, and the Air conditioning page puts residential systems at 1 to 5 tons.'},
  ],
  ...
  quiz: {
    ...
    answer: 0,
    explanation: 'The room loses 4,161 W and the compressor adds 1,066 W, so 5,226 W has to leave through the outdoor coil.',
  },
};
